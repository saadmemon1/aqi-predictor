...
# 01_Data_Backfill_and_EDA.ipynb
...
code_cells = [
    ...
    (
        "code",
        "!pip install hopsworks pandas numpy openmeteo-requests requests-cache retry-requests matplotlib seaborn scikit-learn"
    ),
    (
        "code",
        "import pandas as pd\n"
    ...
    (
        "code",
        "# Log in to Hopsworks\n"
        "# Ensure you have your Hopsworks API key ready\n"
...
for cell_type, source in code_cells:
    if cell_type == "markdown":
        nb.cells.append(nbf.v4.new_markdown_cell(source))
    else:
        nb.cells.append(nbf.v4.new_code_cell(source))

with open('notebooks/01_Data_Backfill_and_EDA.ipynb', 'w') as f:
    nbf.write(nb, f)
